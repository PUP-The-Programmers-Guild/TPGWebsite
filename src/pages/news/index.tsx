    ...
    <>
      ...
      <div className="z-100" id={styles.eventsaccomp}>
        <div className="container mx-auto py-20">
          <p className="Subheadings-1 text-white text-5xl pb-20">Events</p>
          <div className="flex">

            {newsDataEvents.map((event) => (
              <div className="flex-1">
                <div className="w-[95%] mx-auto">
                  <img src={event.picture} className="w-[100%] mb-5" alt="" />
                  <p className="Subheadings-1 text-white text-3xl mb-10">{event.title}</p>
                  <RoundButton url="#" text="Read" />
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto py-20">
          <p className="Subheadings-1 text-white text-5xl pb-20">Accomplishments</p>
          <div className="flex">
