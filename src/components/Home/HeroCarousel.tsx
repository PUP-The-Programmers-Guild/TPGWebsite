...
export default function HeroCarousel() {
  ...
  return (
    <section className="relative -z-10 min-h-[calc(100vh-80px)]">
      <h1 className="absolute  left-1/2 top-[calc(50%-80px)] z-10 w-3/4  -translate-x-1/2 -translate-y-1/2 text-center font-heading text-8xl uppercase leading-[96.02px] text-white">
        Empowering the next generation of coders
      </h1>
      <button className="absolute bottom-[calc(3%+80px)] left-1/2 -translate-x-1/2 -translate-y-1/2 text-white">
